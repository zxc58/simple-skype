...
//     socketOn.newOneJoin({ getVideos, setVideos })
//     socketOn.signal({ getVideos })
//   }, []),
//   videos: ({ videos, setVideos }) => useEffect(() => {
//     socketOn.newOneJoin({ videos, setVideos })
//     socketOn.signal({ videos })
//   }, [videos]),
//   room: ({ room, setRoom, setInvitation, setVideos }) => useEffect(() => {
//     if (room) {
//       const { action } = room
//       switch (action) {
//         case 'create':
